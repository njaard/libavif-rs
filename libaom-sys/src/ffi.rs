...
extern "C" {
    ...
    #[doc = "     The control ID was zero, or the data was not valid."]
...
pub struct aom_partition_features {
    ...
    #[doc = " corresponding type is vaild. The bitmask follows the enum order for"]
    #[doc = " PARTITION_TYPE in \"enums.h\" to represent one partition type at a bit."]
    #[doc = " For example, 0x01 stands for only PARTITION_NONE is valid,"]
    #[doc = " 0x09 (00...001001) stands for PARTITION_NONE and PARTITION_SPLIT are valid."]
...
pub struct aom_codec_enc_cfg {
    ...
    #[doc = " If a value of 0 is provided, encoder will NOT use fixed QP offsets."]
    ...
    #[doc = ""]
    #[doc = " TODO(aomedia:3269): Remove fixed_qp_offsets in libaom v4.0.0."]
...
extern "C" {
    ...
    #[doc = "                         Encoding sample values outside the range"]
    #[doc = "                         [0..(1<<img->bit_depth)-1] is undefined behavior."]
...
#[doc = ""]
#[doc = " Valid range: 0..10. 0 runs the slowest, and 10 runs the fastest;"]
#[doc = " quality improves as speed decreases (since more compression"]
#[doc = " possibilities are explored)."]
#[doc = ""]
#[doc = " NOTE: 10 is only allowed in AOM_USAGE_REALTIME. In AOM_USAGE_GOOD_QUALITY"]
#[doc = " and AOM_USAGE_ALL_INTRA, 9 is the highest allowed value. However,"]
#[doc = " AOM_USAGE_GOOD_QUALITY treats 7..9 the same as 6. Also, AOM_USAGE_REALTIME"]
#[doc = " treats 0..4 the same as 5."]
...
#[doc = " Possible values are in the form of \"ABxy\"."]
#[doc = "  - AB: OP index."]
#[doc = "  - xy: Target level index for the OP. Can be values 0~23 (corresponding to"]
#[doc = "    level 2.0 ~ 7.3, note levels 2.2, 2.3, 3.2, 3.3, 4.2, 4.3, 7.0, 7.1, 7.2"]
#[doc = "    & 7.3 are undefined) or 24 (keep level stats only for level monitoring)"]
#[doc = "    or 31 (maximum level parameter, no level-based constraints)."]
#[doc = ""]
#[doc = " E.g.:"]
#[doc = " - \"0\" means target level index 0 (2.0) for the 0th OP;"]
#[doc = " - \"109\" means target level index 9 (4.1) for the 1st OP;"]
#[doc = " - \"1019\" means target level index 19 (6.3) for the 10th OP."]
#[doc = ""]
...
#[doc = ""]
#[doc = " - 0 = disable"]
#[doc = " - 1 = enable for all frames (default)"]
#[doc = " - 2 = disable for non-reference frames"]
...
#[doc = " Note: it can not work with non RD pick mode in real-time encoding,"]
#[doc = " where the max transform size is only 16x16."]
#[doc = " It will be ignored if non RD pick mode is set."]
#[doc = ""]
...
#[doc = ""]
#[doc = " Valid range: [0, 1000]"]
pub const AV1E_SET_DELTAQ_STRENGTH: aome_enc_control_id = 148;
#[doc = "Codec control to control loop filter"]
#[doc = ""]
#[doc = " - 0 = Loop filter is disabled for all frames"]
#[doc = " - 1 = Loop filter is enabled for all frames"]
#[doc = " - 2 = Loop filter is disabled for non-reference frames"]
#[doc = " - 3 = Loop filter is disabled for the frames with low motion"]
...
#[doc = " unsigned int parameter"]
#[doc = " - 0 = do not use the feature"]
#[doc = " - 1 = enable the automatic decision to turn off several intra tools"]
...
#[doc = " encoders."]
#[doc = " - 1 = Enable rate control for external encoders. This will disable content"]
#[doc = " dependency in rate control and cyclic refresh."]
#[doc = " - 0 = Default. Disable rate control for external encoders."]
...
#[doc = " simulation of frame parallel encode in FPMT unit test, unsigned int"]
#[doc = " parameter"]
#[doc = ""]
#[doc = " - 0 = simulate frame parallel encode"]
#[doc = " - 1 = actual frame parallel encode (default)"]
#[doc = ""]
...
#[doc = " each operating point. int* parameter. There can be at most 32 operating"]
#[doc = " points. The results will be written into a provided integer array of"]
#[doc = " sufficient size. If a target level is not set, the result will be 31."]
#[doc = " Please refer to https://aomediacodec.github.io/av1-spec/#levels for more"]
#[doc = " details on level definitions and indices."]
...
#[doc = ""]
#[doc = " Changes the encoder to use a different distortion metric for RD search. Note"]
#[doc = " that this value operates on a \"lower level\" compared to aom_tune_metric - it"]
#[doc = " affects the distortion metric inside a block, while aom_tune_metric only"]
#[doc = " affects RD across blocks."]
#[doc = ""]
...
#[doc = " frame is decoded at, int* parameter"]
#[doc = ""]
#[doc = " This may be different to the intended display size for the frame as"]
...
#[doc = ""]
#[doc = " \\attention When configured with -DCONFIG_ACCOUNTING=0, the default, this"]
...
#[doc = " encoded frame, aom_tile_data* parameter"]
...
#[doc = ""]
#[doc = " \\attention When configured with -DCONFIG_INSPECTION=0, the default, this"]
#[doc = " returns AOM_CODEC_INCAPABLE."]
...
#[doc = " decoded, int* parameter"]
#[doc = ""]
#[doc = " This will return a flag of type aom_codec_frame_flags_t."]
...
#[doc = " decoded, aom_tile_info* parameter"]
#[doc = ""]
#[doc = " This will return a struct of type aom_tile_info."]
pub const AOMD_GET_TILE_INFO: aom_dec_control_id = 286;
#[doc = "Codec control function to get screen content tools information,"]
#[doc = " aom_screen_content_tools_info* parameter"]
#[doc = ""]
...
#[doc = " aom_still_picture_info* parameter"]
pub const AOMD_GET_STILL_PICTURE: aom_dec_control_id = 288;
#[doc = "Codec control function to get superblock size,"]
#[doc = " aom_superblock_size_t* parameter"]
#[doc = ""]
#[doc = " It returns an enum, indicating the superblock size read from the sequence"]
#[doc = " header(0 for BLOCK_64X64 and 1 for BLOCK_128X128)"]
pub const AOMD_GET_SB_SIZE: aom_dec_control_id = 289;
#[doc = "Codec control function to check if the previous frame"]
#[doc = " decoded has show existing frame flag set, int* parameter"]
...
#[doc = " aom_s_frame_info* parameter"]
...
#[doc = " Parameters: int mi_row, int mi_col, and MB_MODE_INFO*."]
#[doc = ""]
